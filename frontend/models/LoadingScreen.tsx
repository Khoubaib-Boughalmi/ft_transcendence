		...
		<div className="relative flex h-full w-full flex-col gap-4">
			...
			<div className="flex shrink-0 gap-4">
				<div className="absolute inset-0 -z-10 flex items-center justify-center">
					<div className="aspect-square h-full rounded-full bg-card-600/50 blur-[200px]"></div>
				</div>
				<PlayerSide
					user={session}
					side="left"
			...
			<div className="flex flex-1  flex-col items-center justify-center text-xl text-white/50">
